...
### معرفی وب سرویس آیو اس ام اس
آیو اس ام اس یک وب سرویس کامل برای ارسال و دریافت پیامک و پیامک صوتی و مدیریت کامل خدمات دیگر است که براحتی میتوانید از آن استفاده کنید.

<hr>

### نصب

<p>قبل از نصب نیاز به ثبت نام در سایت آیو اس ام اس دارید.</p>
<p></p>

[**ثبت نام به همراه دریافت 200 پیامک هدیه جهت تست وبسرویس**](https://www.aiosms.ir/)
...
try{
    ...
    $to = '09123456789';
    $from = '5000...';
    $text = 'تست وب سرویس آیو اس ام اس';
...
از آنجا که وب سرویس آیو اس ام اس تنها محدود به ارسال پیامک نیست  شما از طریق  زیر میتوانید به وب سرویس ها دسترسی کامل داشته باشید:
...
##### حالت آسنکرون
شما میتوانید از وب سرویس آیو اس ام اس در حالت آسنکرون هم استفاده کنید. آماده سازی آسنکرون در PHP به صورت زیر است. توجه کنید که دستورات آسنکرون به شرط فراخوانی متد `execute` (بطور موازی) انجام می شوند.
...
[وب سرویس آیو اس ام اس](https://github.com/AliRMT/Webservices)
مراجعه نمایید .
